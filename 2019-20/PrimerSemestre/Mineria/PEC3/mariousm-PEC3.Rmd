...
#c("months_loan_duration", "employment_length", "checking_balance", "credit_history")
#c("months_loan_duration", "purpose", "savings_balance", "checking_balance", "credit_history")
#c("savings_balance", "checking_balance", "credit_history")

col = c("savings_balance", "checking_balance", "credit_history", "months_loan_duration")

modelo_c50 <- C50::C5.0(x = df_copy[, col], y = as.factor(df_copy$default), rules = TRUE)

summary(modelo_c50)

modelo_c50 <- C50::C5.0(x = df_copy[, c("savings_balance", "checking_balance", "credit_history", "months_loan_duration")], y = as.factor(df_copy$default))
