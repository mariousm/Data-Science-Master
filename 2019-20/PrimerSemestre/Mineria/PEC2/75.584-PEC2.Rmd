...
Vemos que tenemos 200 registros y 5 variables que los caracterizan. Este dataset está formado por 4 variables numéricas y una variable categórica (el género), por lo que, al hacer un uso posterior del algoritmo kmeans solo nos admite valores numéricos, es por ello que vamos a eliminar la columna género del dataset original:
```{r}
df_clientes_copy = df_clientes[, unlist(lapply(df_clientes, is.numeric))]
