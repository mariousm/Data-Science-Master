...
Para analizar los residuos vamos a crear dos gráficos. El primero nos permite ver si la varianza es constante, para ello representamos los residuos vs los valores ajustados:
```{r}
