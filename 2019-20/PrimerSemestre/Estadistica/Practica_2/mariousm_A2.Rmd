...
Lo primero que vamos a hacer es un sample de la muestra de zurdos y de diestros:
```{r}
Left.sample = df_copy_players_left[1:3,]
Right.sample = df_copy_players_right[1:5,]
